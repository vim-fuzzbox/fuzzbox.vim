...
command! -nargs=0 FuzzyCmdHistory launcher.Start('chistory')
command! -nargs=0 FuzzySearchHistory launcher.Start('shistory')
...
command! -nargs=0 FuzzyChanges launcher.Start('changes')
